...
public partial class admin_myin : System.Web.UI.Page
{
    string id;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(typeof(string), "print", "<script>alert('" + "修改成功" + "');window.location.href ='myin.aspx'</script>");
        }
        else {
