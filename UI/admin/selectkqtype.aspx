<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_kqgl.master" AutoEventWireup="true" CodeFile="selectkqtype.aspx.cs" Inherits="admin_addkqtype" %>
    ...
    <div class="place">
        ...
        <div class="formbody">
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        <li><a href="" class="selected">修改考勤类别</a></li>
